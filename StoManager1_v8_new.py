...
class Ui_StoManager1(object):
    ...
    def setupUi(self, StoManager1):
        StoManager1.setObjectName("StoManager1_v8_Seg-x_Hardwoods")
...
"background-color: rgb(255, 255, 255);")
        ...
        self.lineEdit.setStyleSheet("QLineEdit { background: rgb(255, 255, 255); selection-background-color: rgb(233, 99, 0); }")
        ...
        self.pushButton_8.setStyleSheet('QPushButton {background-color: rgb(196, 124, 180); }')
        ...
        self.lineEdit_2.setStyleSheet("QLineEdit { background: rgb(255, 255, 255); selection-background-color: rgb(233, 99, 0); }")
        ...
        self.pushButton_9.setStyleSheet('QPushButton {background-color: rgb(196, 124, 180); }')
        ...
        self.lineEdit_4.setStyleSheet("QLineEdit { background: rgb(255, 255, 255); selection-background-color: rgb(233, 99, 0); }")
        ...
        self.lineEdit_5.setStyleSheet("QLineEdit { background: rgb(255, 255, 255); selection-background-color: rgb(233, 99, 0); }")
        ...
        self.pushButton_3.setStyleSheet('QPushButton {background-color: rgb(79, 186, 112);}')
...
"")
        ...
        self.action.triggered.connect(self.web_link_google_scholar)        
        ...
        self.actionGroupAnalysis = QtWidgets.QAction(StoManager1)
        self.actionGroupAnalysis.setObjectName("actionGroupAnalysis")
        self.actionGroupAnalysis.triggered.connect(self.StatisticsGroup)
        ...
        self.menuHelp.addAction(self.actionGroupAnalysis)
    ...
    def retranslateUi(self, StoManager1):
        ...
        self.actionMy_Homepage.setText(_translate("StoManager1", "Homepage"))
        self.actionGroupAnalysis.setText(_translate("StoManager1", "Group Analysis"))
    ...
    def check_input_Path_run(self):
        """ check if the input path is defined """
        try:
            self.input_image_path_ = self.lineEdit.text()
                    # get first image file and show it
            image_files = glob.glob(self.input_image_path_ + "/" + '*jpg')
...
###### Main components ######
    ...
    def GuardCell(self):
        ...
        if bool(glob.glob(self.folder + "/" + '*jpg')) is True:
    ...
    def outofIndex(self,e):
        ...
        # declaring buttons on Message Box
        msg.setStandardButtons(QtWidgets.QMessageBox.Ok)
        msg.setInformativeText("This the end of the range of the images. 🐻")       
        # start the app
        x = msg.exec_()
    ...
    def raiseError(self,e):
        ...
        # declaring buttons on Message Box
        msg.setStandardButtons(QtWidgets.QMessageBox.Ok)
        msg.setInformativeText("There was something went wrong. None Type object error means no stoma detected in the given images. If it's GPU memory error, you can use the CPU version. 🐻")       
        # start the app
        x = msg.exec_()        
...
# webbrowser
    ...
    def web_link_Early_versions(self):
        """ """
        webbrowser.open("https://doi.org/10.5281/zenodo.7686022")                 
