...
class Ui_StoManager1(object):
    ...
    def setupUi(self, StoManager1):
        ...
        StoManager1.setFixedSize(1321, 964)
        ...
        self.frame.setGeometry(QtCore.QRect(0, 0, 1321, 911))
        self.frame.setStyleSheet("")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.frame_2 = QtWidgets.QFrame(self.frame)
        self.frame_2.setGeometry(QtCore.QRect(0, 0, 691, 911))
        self.frame_2.setStyleSheet("")
        self.frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_2.setObjectName("frame_2")
        self.label_3 = QtWidgets.QLabel(self.frame_2)
        self.label_3.setGeometry(QtCore.QRect(40, 880, 621, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_3.setFont(font)
        self.label_3.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 255, 255, 255), stop:1 rgba(255, 255, 255, 255));")
        self.label_3.setObjectName("label_3")
        self.progressBar = QtWidgets.QProgressBar(self.frame_2)
        self.progressBar.setEnabled(True)
        self.progressBar.setGeometry(QtCore.QRect(30, 330, 641, 24))
        ...
        self.progressBar.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0,0, 0, 255), stop:1 rgba(0, 0, 0, 255));")
        self.progressBar.setProperty("value", 0)
        self.progressBar.setTextVisible(True)
        self.progressBar.setObjectName("progressBar")
        self.layoutWidget = QtWidgets.QWidget(self.frame_2)
        self.layoutWidget.setGeometry(QtCore.QRect(30, 13, 641, 301))
        ...
        self.pushButton_8.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(0, 0, 0, 255));\n"
"")
        ...
        self.pushButton_9.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0,0, 255), stop:1 rgba(0, 0, 0, 255));\n"
"")
        ...
        self.pushButton_3.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(0, 0, 0, 255));")
        self.pushButton_3.setObjectName("pushButton_3")
        self.pushButton_3.clicked.connect(lambda: [self.run_analyze(), self.show_info_messagebox()])
        self.horizontalLayout_3.addWidget(self.pushButton_3)
        self.pushButton_6 = QtWidgets.QPushButton(self.layoutWidget)
        self.pushButton_6.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(0, 0, 0, 255));")
        ...
        self.pushButton_7.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(0, 0, 0, 255));")
        self.pushButton_7.setObjectName("pushButton_7")
        self.pushButton_7.clicked.connect(lambda: [self.Stomata_with_no_groups(), self.show_info_messagebox_group_analysis()])
        self.horizontalLayout_3.addWidget(self.pushButton_7)
        self.verticalLayout.addLayout(self.horizontalLayout_3)
        self.layoutWidget1 = QtWidgets.QWidget(self.frame_2)
        self.layoutWidget1.setGeometry(QtCore.QRect(32, 380, 641, 501))
        ...
        self.pushButton_15.setStyleSheet("border-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(43, 197, 227, 255));")
        ...
        self.pushButton_16.setStyleSheet("border-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(43, 197, 227, 255));")
        ...
        self.label.setGeometry(QtCore.QRect(0, 0, 1321, 911))
        self.label.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(30, 141, 162, 235));")
        self.label.setText("")
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.frame)
        self.label_2.setGeometry(QtCore.QRect(0, 0, 1311, 911))
        self.label_2.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(0, 0, 0, 91));")
        self.label_2.setText("")
        self.label_2.setObjectName("label_2")
        self.frame_3 = QtWidgets.QFrame(self.frame)
        self.frame_3.setGeometry(QtCore.QRect(700, 0, 601, 911))
        self.frame_3.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_3.setObjectName("frame_3")
        self.label_9 = QtWidgets.QLabel(self.frame_3)
        self.label_9.setGeometry(QtCore.QRect(300, 880, 41, 31))
        font = QtGui.QFont()
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(22, 20, 571, 421))
        ...
        self.pushButton.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(0, 0, 0, 255));")
        ...
        self.pushButton_4.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(0, 0, 0, 255));")
        ...
        self.pushButton_10.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(0, 0, 0, 255));")
        ...
        self.graphicsView.setStyleSheet("border-radius:15px;")
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(22, 460, 571, 421))
        ...
        self.pushButton_2.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(0, 0, 0, 255));")
        ...
        self.pushButton_5.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(0, 0, 0, 255));")
        ...
        self.pushButton_11.setStyleSheet("color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(0, 0, 0, 255));")
        ...
        self.graphicsView_2 = QtWidgets.QGraphicsView(self.layoutWidget3)
        ...
        self.actionGroup_Analysis.triggered.connect(lambda: [self.show_info_messagebox_group_analysis1(), self.Stomata()])
        ...
        self.actionNon_Group_Analysis.triggered.connect(lambda: [self.Stomata_with_no_groups(), self.show_info_messagebox_group_analysis()])
    ...
    def check_input_Path(self):
        input_image_path_ = self.lineEdit.text()
                # get first image file and show it
        image_files = glob.glob(input_image_path_ + "/" + '*jpg')
    ...
    def check_output_Path(self):
        output_image_path_ = self.lineEdit_2.text()
                # get first image file and show it
        image_files_2 = glob.glob(output_image_path_ + "/" + '*jpg')
...
#next labeled image
    def output_next_image_clicked(self):
        # get first image file and show it
        output_image_path_ = self.lineEdit_2.text()
        image_files = glob.glob(output_image_path_ + "/" + '*jpg')
...
###### Main components ######
    ...
    def NormalizeFileNames(self):
        ...
        file_path = glob.glob(Input_path + "/" + '*jpg')[2]
    ...
    def Stomata(self):
        ...
        if bool(glob.glob(folder_path + '/' + 'Statistics.csv')) is True:
            os.remove(glob.glob(folder_path + '/' + 'Statistics.csv')[0])
        else:
    ...
    def loadCsv(self):
        ...
        for file_path in glob.glob(filepath + '/' + '*.csv'):
            fileName = file_path
    ...
    def loadExl(self):
        ...
        self.tableView.setModel(self.model)
        filepath = self.lineEdit_2.text()
        if bool(glob.glob(filepath + '/' + '*.xlsx')):
            for file_path in glob.glob(filepath + '/' + '*.xlsx'):
                newpath =  filepath + f'/New_folder' 
    ...
    def show_info_messagebox_normalize(self):
        ...
        msg.setWindowIcon(QtGui.QIcon('StoManager.ico'))
        # setting message for Message Box
        msg.setText("Opps... Now filename normalizer is only applicable for our Populus dataset. It will work if you are playing our Populus dataset.")
        # setting Message box window title
