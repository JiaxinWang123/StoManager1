...
"")
    ...
    def retranslateUi(self, StoManager1):
        ...
        StoManager1.setWindowTitle(_translate("MainWindow", "StoManager1 v.1.0.0."))
        self.pushButton.setText(_translate("MainWindow", "<< View previous"))
        self.pushButton_4.setText(_translate("MainWindow", "View original images"))
        self.pushButton_10.setText(_translate("MainWindow", "View next >>"))
        self.pushButton_2.setText(_translate("MainWindow", "<< View previous"))
        self.pushButton_5.setText(_translate("MainWindow", "View detected images"))
        self.pushButton_11.setText(_translate("MainWindow", "View next >>"))
        self.lineEdit.setText(_translate("MainWindow", "Input path"))
        self.pushButton_8.setText(_translate("MainWindow", "Input"))
        self.lineEdit_2.setText(_translate("MainWindow", "Output path"))
        self.pushButton_9.setText(_translate("MainWindow", "Output"))
        self.YOLOv8_seg_x.setText(_translate("MainWindow", "Segment model using trained YOLOv8-seg-x"))
        self.lineEdit_4.setText(_translate("MainWindow", "Input pixels in 0.1 mm, the default is: 465"))
        self.lineEdit_5.setText(_translate("MainWindow", "Confidence threshold for detection the default is 0.25"))
        self.pushButton_3.setText(_translate("MainWindow", "Start Process"))
        self.pushButton_6.setText(_translate("MainWindow", "Normalize File"))
        self.pushButton_7.setText(_translate("MainWindow", "Statistical Analysis"))
        self.pushButton_15.setText(_translate("MainWindow", "Preview exported table for single image"))
        self.pushButton_16.setText(_translate("MainWindow", "Preview exported statistics for all images"))
        self.label_3.setText(_translate("MainWindow", "© Jiaxin Wang.  For questions or requests 📧  coolwjx@foxmail.com; jw3994@msstate.edu"))
        self.label_9.setText(_translate("MainWindow", "💕   LU"))
        ...
        self.actionYOLOv8_seg_x.setText(_translate("MainWindow", "YOLOv8-seg-x"))
        self.actionGoogle_scholar.setText(_translate("MainWindow", "Google scholar"))
        self.actionarXiv.setText(_translate("MainWindow", "arXiv"))
        self.actionGitHub.setText(_translate("MainWindow", "GitHub"))
        self.actionMy_Homepage.setText(_translate("MainWindow", "My Homepage"))
        self.actionEarly_versions.setText(_translate("MainWindow", "Early versions"))
        self.actionOnly_whole_stomata.setText(_translate("MainWindow", "Only whole_stomata"))
        self.actionOnly_stomata_aperture.setText(_translate("MainWindow", "Only stomata (aperture)"))
        self.actionOnly_guard_cell.setText(_translate("MainWindow", "Only guard cell"))
        self.actionAll_metrics.setText(_translate("MainWindow", "All metrics"))
        self.actionGroup_Analysis.setText(_translate("MainWindow", "Group Analysis"))
        self.actionOpen_training_window.setText(_translate("MainWindow", "Train YOLOv8-seg-x"))
